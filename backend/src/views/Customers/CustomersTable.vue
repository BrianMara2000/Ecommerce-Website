  ...
  <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
    ...
    <table class="table-auto w-full">
      <thead>
        <tr class="animate-fade-in-down text-center">
          ...
          <TableHeaderCell
            ...
            :sort-field="sortField"
            :sort-direction="sortDirection"
            >Registration Date</TableHeaderCell
          >
          <!-- <TableHeaderCell
            @click="sortCustomers"
            class="border-b-2 p-2 text-left"
      ...
      <tbody v-if="customers.loading">
        <tr>
          <td colspan="7">
            <Spinner v-if="customers.loading" class="mt-3" />
          </td>
        </tr>
      </tbody>
      <tbody v-else>
        ...
        >
          ...
          <td class="border-b p-2">{{ formatDate(customer.created_at) }}</td>
    ...
    <div
      ...
      :class="!customers.data.length ? 'justify-center' : 'justify-between'"
      class="flex items-center mt-5"
    >
      <span class="text-center" v-if="!customers.data.length"
...
const formatDate = (isoDate) => {
  ...
  return date.toLocaleString(undefined, options); // Adjusts to the customer's locale
};
