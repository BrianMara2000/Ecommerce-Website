<template>
  <div class="bg-white grid">
    ...
    >
      <h2
        class="text-2xl text-center xl:text-left font-bold tracking-tight text-gray-900"
      >
        Latest Product List
      </h2>
      <div
        class="grid grid-cols-1 justify-self-center mt-6 gap-7 sm:grid-cols-2 lg:grid-cols-4"
      >
        <div
          class="flex flex-col w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
        ...
        >
          ...
          <div class="px-5 pb-5">
            ...
            <div class="flex gap-5 lg:flex-col items-center justify-between">
